# H3 Prompt Writing — SKILL.md (Verbatim Extract)
...
- **T2VA:** Build the full audiovisual timeline from text alone.
- **I2VA:** Begin from the first frame and develop forward from it.
...
Ref2VA rewrites use these sections in order: `subject_definitions`, `summary`, `retention_analysis`, `detailed_description`, `overall_soundscape`, and `non_diegetic_music`. Reference labels stay consistent across all sections.
...
- Always match the total description length to the requested video span (4–15 seconds).
